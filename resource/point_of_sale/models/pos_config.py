...
class PosConfig(models.Model):
    ...
    boleta_journal_id = fields.Many2one('account.journal', domain=[('type', '=', 'sale')], 
                        string='Boleta',default=_default_invoice_journal)
    cliente_default = fields.Many2one('res.partner')
